...
async def cmd_add_bonus(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    # УСТАНАВЛИВАЕМ (а не добавляем!) щедрые бонусы для тестирования
    # Это гарантирует, что админ получит нужное количество независимо от текущего состояния
    st["video_bonus"] = 30  # 30 бесплатных видео
    st["photo_bonus"] = 50  # 50 бесплатных фото
