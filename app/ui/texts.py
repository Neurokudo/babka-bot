...
T = {
    "ru": {
        ...
        # Длительность видео
        "video.duration": "Выбери длительность видео:",
        "video.duration_6s": "⏱️ 6 секунд (−14 монет)",
        "video.duration_8s": "⏱️ 8 секунд (−18 монет)",
        "video.audio_choice": "Выбери настройки аудио:",
        "video.audio_mute": "🔇 Без звука",
        "video.audio_on": "🔊 Со звуком",
        ...
        "payment.special_pack": "🎁 Разовый пакет",
